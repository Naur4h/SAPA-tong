...
const statusConfig = {
  ...
  penuh: {
    label: "Penuh",
    dot: "bg-alert-deep",
    text: "text-alert-deep",
    bg: "bg-alert-soft",
  },
};

export default function UnitCard({ unit }: { unit: UnitTong }) {
  const nilaiTertinggi = Math.max(unit.organik, unit.anorganik);
